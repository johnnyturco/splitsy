...
item4 = Item.create(bill_id: bill3.id, user_id: johnny.id, item_note: "3 whiskey sours", item_amount: 48, settled: true)
item5 = Item.create(bill_id: bill3.id, user_id: mike.id, item_note: "1 old fashioned, 1 margarita", item_amount: 37, settled: false)
item6 = Item.create(bill_id: bill3.id, user_id: anna.id, item_note: "1 moscow mule, breaded cheese", item_amount: 20, settled: false)
